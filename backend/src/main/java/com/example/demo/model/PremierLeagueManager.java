...
public class PremierLeagueManager implements LeagueManager{
        ...
        if (leagueList.isEmpty()) {     //Display message if leagueList is empty
            ...
            for (FootballClub fclub : leagueList) {
                if (fclub.getClubName().toLowerCase().equals(club.toLowerCase())) {
                    ...
                    System.out.println("Club successfully removed!");
                    break;
                }
            }
            if (!found) {
    ...
    public void displayTable() {
        ...
        if (leagueList.isEmpty()) {
            ...
            leagueList.sort(new TeamComparator().reversed());
    ...
    public void addMatch() {
        ...
        Score.setScore(home, away, hScore, aScore);    //Update the score board based on the match details
    ...
    public static void saveClubs() throws IOException {
    ...
    public static void retrieveMatches() throws IOException {
    ...
    public static void retrieveClubs() throws IOException {
